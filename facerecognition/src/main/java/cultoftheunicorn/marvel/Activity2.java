...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtText= (TextView) this.findViewById(R.id.detected_text);
    ...
    public void register(View v) {
        Intent intent = new Intent(this, ChalanActivity.class);
        startActivity(intent);
    }
    public void databaselocation(View v) {
        Intent intent = new Intent(this, SearchByLocation.class);
        startActivity(intent);
    }
    public void databaseLplate(View v) {
        Intent intent = new Intent(this, SearchBylplate.class);
        startActivity(intent);
    }
