...
public class RetrieveActivity extends AppCompatActivity {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint != null && constraint.length()>0)
            {
                ...
                for (int i=0;i<currentList.size();i++)
                {
                    ...
                    //SEARCH
                    if(spacecraft.getlno().toUpperCase().contains(constraint) )
                    {
                        //ADD IF FOUND
    ...
    class ListViewAdapter extends BaseAdapter implements Filterable {
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(RetrieveActivity.this, DetailsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<Spacecraft>>() {
            ...
            public void onFailure(Call<List<Spacecraft>> call, Throwable throwable) {
                mProgressBar.setVisibility(View.GONE);
                Toast.makeText(RetrieveActivity.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
