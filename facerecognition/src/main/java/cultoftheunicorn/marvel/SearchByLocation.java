...
public class SearchByLocation extends AppCompatActivity {
    ...
    class Spacecraft {
        ...
        public Spacecraft(int id, String lno, String Comments,String Violation, String imageURL, int technologyExists, String count, String place) {
            this.id = id;
            this.lno = lno;
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint != null && constraint.length()>0)
            {
                ...
                for (int i=0;i<currentList.size();i++)
                {
                    ...
                    //SEARCH
                    if(spacecraft.getplace().toUpperCase().contains(constraint) )
                    {
                        //ADD IF FOUND
    ...
    class ListViewAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            if(view==null)
            {
                view=LayoutInflater.from(context).inflate(R.layout.modelforlocation,viewGroup,false);
            }
        ...
        private void openDetailActivity(String[] data) {
            Intent intent = new Intent(SearchByLocation.this, DetailsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<Spacecraft>>() {
            ...
            public void onFailure(Call<List<Spacecraft>> call, Throwable throwable) {
                mProgressBar.setVisibility(View.GONE);
                Toast.makeText(SearchByLocation.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
